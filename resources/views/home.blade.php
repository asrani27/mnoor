    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div class="text-center">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-2 tracking-tight">
                <span
                    class="bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 bg-clip-text text-transparent">SURVEY
                    KEPUASAN</span>
                <br>
            ...
            <p class="text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-8">
                Platform survei untuk mengukur dan meningkatkan kepuasan masyarakat terhadap layanan publik dengan hasil
                yang transparan dan akurat.
            </p>
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('register') }}"
                    class="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl font-semibold text-lg hover:shadow-2xl hover:shadow-blue-500/30 transition-all duration-300 transform hover:-translate-y-1">
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
            class="bg-gradient-to-br from-blue-500/20 to-blue-600/10 backdrop-blur-md rounded-3xl p-8 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
            ...
            <p class="text-white/60">Proses survey yang simpel dan cepat dengan antarmuka yang intuitif untuk semua
                kalangan.</p>
        </div>
        <div
            class="bg-gradient-to-br from-indigo-500/20 to-indigo-600/10 backdrop-blur-md rounded-3xl p-8 border border-indigo-500/20 hover:border-indigo-500/40 transition-all duration-300">
            ...
            <p class="text-white/60">Data survey terenkripsi dengan aman dan privasi responden dijamin kerahasiaannya.
            </p>
        </div>
        <div
            class="bg-gradient-to-br from-purple-500/20 to-purple-600/10 backdrop-blur-md rounded-3xl p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
            ...
            <p class="text-white/60">Hasil survey divisualisasikan dalam bentuk grafik yang informatif dan mudah
                dipahami.</p>
        </div>
    </div>
</div>
