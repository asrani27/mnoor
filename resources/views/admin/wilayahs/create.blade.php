...
@section('title', 'Create Wilayah')
@section('header', 'Create Wilayah')
@section('breadcrumb', 'Add new wilayah')
...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <form action="{{ route('admin.wilayahs.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            <div>
